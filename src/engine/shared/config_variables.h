...
MACRO_CONFIG_INT(SvHighBandwidth, sv_high_bandwidth, 0, 0, 10, CFGFLAG_SERVER, "Use high bandwidth mode. Doubles the bandwidth required for the server. LAN use only")
