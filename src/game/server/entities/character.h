...
public:
	...
	void ManualSnap(int SnappingClient, int FakeID, int *RealToFake = NULL, bool FixHook = false);
	bool IsGrounded();
...
private:
	...
	void SnapCharacter(int SnappingClient, int ID, int *RealToFake = NULL, bool FixHook = false);
...
public:
	...
	int GetEmoteType() { return m_EmoteType; };
