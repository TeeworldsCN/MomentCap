...
CHAT_COMMAND("pose", "", CFGFLAG_CHAT | CFGFLAG_SERVER, ConPoseCapture, this, "Pose")
CHAT_COMMAND("mk_cap", "s[capture name]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConForceCapture, this, "Force capture")
CHAT_COMMAND("caps_by", "s[capture name]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConShowOwnedBy, this, "Check caps owned by a name")
CHAT_COMMAND("whois", "s[address]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConWhoisCapture, this, "Check caps owned by a name")
// CHAT_COMMAND("free_cap", "s[capture name]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConFreeIPAddress, this, "Free a cap from IP address limit")
// CHAT_COMMAND("lk_cap", "s[capture name] s[code]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConSetCaptureTimeout, this, "Set cap's timeout code")
...
// CHAT_COMMAND("hook+", "?s[capture name]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConCaptureHookPlus, this, "Enlong your hook")
// CHAT_COMMAND("hook-", "?s[capture name]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConCaptureHookMinus, this, "Shorten your hook")
