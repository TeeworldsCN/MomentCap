...
MACRO_CONFIG_INT(SvVoteSpectate, sv_vote_spectate, 0, 0, 0, CFGFLAG_SERVER, "Allow voting to move players to spectators")
MACRO_CONFIG_INT(SvVoteSpectateRejoindelay, sv_vote_spectate_rejoindelay, 3, 0, 1000, CFGFLAG_SERVER, "How many minutes to wait before a player can rejoin after being moved to spectators by vote")
MACRO_CONFIG_INT(SvVoteKick, sv_vote_kick, 0, 0, 0, CFGFLAG_SERVER, "Allow voting to kick players")
...
MACRO_CONFIG_INT(SvCaptureInterval, sv_capture_interval, 5, -1, 60, CFGFLAG_SERVER, "Time to wait between captures, -1 = disable")
...
MACRO_CONFIG_INT(SvSaveInterval, sv_save_interval, 40, -1, 18000, CFGFLAG_SERVER, "Backup interval, -1 = no save")
...
MACRO_CONFIG_INT(SvCrowdednessCheck, sv_crowdedness_check, 48, 0, 63, CFGFLAG_SERVER, "How many tees shown at the same screen to be considered as crowded")
...
MACRO_CONFIG_INT(DbgDummies, dbg_dummies, 0, 0, 500, CFGFLAG_SERVER, "")
#endif
